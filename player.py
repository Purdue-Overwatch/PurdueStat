...
DAMAGE_HEROES = ['Echo', 'Pharah', 'Doomfist', 'Junkrat', 'Mei', 'Sombra', 'Torbjorn', 'Genji', 'Hanzo', 'Symmetra', \
    'Reaper', 'Soldier: 76', 'Tracer', 'Bastion', 'Ashe', 'Cassidy', 'Widowmaker']
...
class Player:
    ...
    def set_in_game_stats(self):
        ...
        for key, val in final_stats.items():
            stats_per_minute[key] = float(decimal.Decimal(round(val / game_length * 60, 2)))
    ...
    def set_all(self):
        ...
        '''
        self.set_heroes_played()
        self.set_role()
        self.set_ult_time_stats()
        self.set_in_game_stats()
